...
df_test = pd.merge(
    df_test, Get_Protein_Feature(list(pro_list_test)), on="Protein", how="left"
)
...
# Add check for empty pth_files list
if not pth_files:
    raise FileNotFoundError(
        f"No .pth model files found in the specified folder: {folder_path}. "
        f"Please check the path or ensure the trained models are present."
    )
